    ...
    <div class="card-body">
        <div class="conitaner-fluid">
            ...
            <table class="table-striped table table-bordered">
                ...
                <tbody>
                    <?php 
                        $olist = $conn->query("SELECT o.*,p.product_name,p.company FROM order_list o inner join products p on o.product_id = p.id where o.order_id = '{$id}' ");
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="m-0"><small>Author: <?php echo $row['company']?></small></p>
