                ...
                <tbody>
                    ...
                    $i = 1;
                        ...
                        while($row = $qry->fetch_assoc()):
                            $olist = $conn->query("SELECT ol.*,p.product_name,p.company,concat(c.firstname,' ',c.lastname) as name,c.email,o.date_created FROM order_list ol inner join orders o on o.id = ol.order_id inner join `products` p on p.id = ol.product_id inner join clients c on c.id = o.client_id  where ol.order_id = '{$row['order_id']}' ");
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="m-0"><small>By: <?php echo $roww['company'] ?></small></p>
                        </td>
                        <td>
