<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-yellow elevation-4 sidebar-no-expand">
        <!-- Brand Logo -->
        <a href="<?php echo base_url ?>admin" class="brand-link bg-yellow text-sm">
        ...
        <!-- Sidebar -->
        <div class="sidebar sidebar-dark os-host os-theme-light os-host-overflow os-host-overflow-y os-host-resize-disabled os-host-transition os-host-scrollbar-horizontal-hidden">
