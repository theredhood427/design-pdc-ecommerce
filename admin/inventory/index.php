        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT i.*,p.product_name as product,p.company from `inventory` i inner join `products` p on p.id = i.product_id order by unix_timestamp(i.date_created) desc ");
					...
					?>
						<tr>
							...
							<td>
								...
								<p class="m-0 truncate"><b>Company:</b> <?php echo $row['company'] ?></p>
							</td>
