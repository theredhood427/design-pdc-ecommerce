...
if(isset($_GET['c']) && isset($_GET['s'])){
 ...
 $sub_cat_qry = $conn->query("SELECT * FROM sub_categories where md5(id) = '{$_GET['s']}'");
    if($sub_cat_qry->num_rows > 0){
        ...
        $sub_product_name = $result['sub_category'];
...
<header class="bg-dark py-5" id="main-header">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            ...
            <p class="lead fw-normal text-white-50 mb-0"><?php echo $sub_product_name ?></p>
        </div>
    </div>
</header>
<!-- Section-->
        ...
        <div class="<?php echo isset($_GET['c'])? 'col-md-9': 'col-md-10 offset-md-1' ?>">
            ...
            <div class="tab-content pt-2">
                <div class="tab-pane fade show active" id="book">
                    ...
                    <div class="row gx-2 gx-lg-2 row-cols-1 row-cols-md-3 row-cols-xl-3">
                        ...
                        <?php 
                            $whereData = "";
                            if(isset($_GET['search']))
                                $whereData = " and (product_name LIKE '%{$_GET['search']}%' or company LIKE '%{$_GET['search']}%' or description LIKE '%{$_GET['search']}%')";
                ...
                <div class="tab-pane fade" id="details">
                    ...
                    <h3 class="text-center"><?php echo $sub_product_name?></h3>
                    <hr>
                    <div>
